...
nota C tem peso 5. Considere que cada nota pode ir de 0 
...
abaixo, com 1 dígito após o ponto decimal e com um espaço em 
branco antes e depois da igualdade. Assim como todos os problemas, 
...
int main(){
    ...
    double media = (nota_a * 2.0 + nota_b * 3.0 + nota_c * 5.0) / 10.0;
